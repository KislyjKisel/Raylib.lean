...
static inline void lean_raylib_Vector3_set (b_lean_obj_arg obj, Vector3 v) {
    lean_ctor_set(obj, 0, lean_box_uint32(lean_pod_Float32_toBits(v.x)));
    lean_ctor_set(obj, 1, lean_box_uint32(lean_pod_Float32_toBits(v.y)));
    lean_ctor_set(obj, 2, lean_box_uint32(lean_pod_Float32_toBits(v.z)));
}
...
static inline Vector3 lean_raylib_Vector3_from (b_lean_obj_arg obj) {
    ...
    v.x = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 0)));
    v.y = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 1)));
    v.z = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 2)));
    return v;
}
...
static inline void lean_raylib_Vector4_set (b_lean_obj_arg obj, Vector4 v) {
    ...
    lean_ctor_set(obj, 1, lean_box_uint32(lean_pod_Float32_toBits(v.y)));
    lean_ctor_set(obj, 2, lean_box_uint32(lean_pod_Float32_toBits(v.z)));
    lean_ctor_set(obj, 3, lean_box_uint32(lean_pod_Float32_toBits(v.w)));
}
...
static inline Vector4 lean_raylib_Vector4_from (b_lean_obj_arg obj) {
    ...
    v.y = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 1)));
    v.z = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 2)));
    v.w = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 3)));
    return v;
}
...
static inline void lean_raylib_Matrix_set (b_lean_obj_arg obj, Matrix m) {
    lean_ctor_set(obj, 0, lean_box_uint32(lean_pod_Float32_toBits(m.m0)));
    lean_ctor_set(obj, 1, lean_box_uint32(lean_pod_Float32_toBits(m.m4)));
    lean_ctor_set(obj, 2, lean_box_uint32(lean_pod_Float32_toBits(m.m8)));
    lean_ctor_set(obj, 3, lean_box_uint32(lean_pod_Float32_toBits(m.m12)));
    lean_ctor_set(obj, 4, lean_box_uint32(lean_pod_Float32_toBits(m.m1)));
    lean_ctor_set(obj, 5, lean_box_uint32(lean_pod_Float32_toBits(m.m5)));
    lean_ctor_set(obj, 6, lean_box_uint32(lean_pod_Float32_toBits(m.m9)));
    lean_ctor_set(obj, 7, lean_box_uint32(lean_pod_Float32_toBits(m.m13)));
    lean_ctor_set(obj, 8, lean_box_uint32(lean_pod_Float32_toBits(m.m2)));
    lean_ctor_set(obj, 9, lean_box_uint32(lean_pod_Float32_toBits(m.m6)));
    lean_ctor_set(obj, 10, lean_box_uint32(lean_pod_Float32_toBits(m.m10)));
    lean_ctor_set(obj, 11, lean_box_uint32(lean_pod_Float32_toBits(m.m14)));
    lean_ctor_set(obj, 12, lean_box_uint32(lean_pod_Float32_toBits(m.m3)));
    lean_ctor_set(obj, 13, lean_box_uint32(lean_pod_Float32_toBits(m.m7)));
    lean_ctor_set(obj, 14, lean_box_uint32(lean_pod_Float32_toBits(m.m11)));
    lean_ctor_set(obj, 15, lean_box_uint32(lean_pod_Float32_toBits(m.m15)));
}
...
static inline Matrix lean_raylib_Matrix_from (b_lean_obj_arg obj) {
    Matrix m;
    m.m0 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 0)));
    m.m4 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 1)));
    m.m8 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 2)));
    m.m12 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 3)));
    m.m1 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 4)));
    m.m5 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 5)));
    m.m9 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 6)));
    m.m13 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 7)));
    m.m2 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 8)));
    m.m6 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 9)));
    m.m10 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 10)));
    m.m14 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 11)));
    m.m3 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 12)));
    m.m7 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 13)));
    m.m11 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 14)));
    m.m15 = lean_pod_Float32_fromBits(lean_unbox_uint32(lean_ctor_get(obj, 15)));
    return m;
}
